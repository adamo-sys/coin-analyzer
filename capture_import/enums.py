...
class ErrorCategory(str, Enum):
    ...
    PROCESSED_CONTRACT_VIOLATION = "PROCESSED_CONTRACT_VIOLATION"
    PROCESSED_CONTAINMENT_VIOLATION = "PROCESSED_CONTAINMENT_VIOLATION"
    PROCESSED_DIGEST_MISMATCH = "PROCESSED_DIGEST_MISMATCH"
    PROCESSED_SIZE_MISMATCH = "PROCESSED_SIZE_MISMATCH"
    UNSUPPORTED_PROCESSED_SNAPSHOT_VERSION = "UNSUPPORTED_PROCESSED_SNAPSHOT_VERSION"
    DUPLICATE_PROCESSED_ARTIFACT = "DUPLICATE_PROCESSED_ARTIFACT"
    PROCESSED_ARTIFACT_MISSING = "PROCESSED_ARTIFACT_MISSING"
    PROCESSED_OWNERSHIP_LOST = "PROCESSED_OWNERSHIP_LOST"
    PROCESSED_SOURCE_MUTATION = "PROCESSED_SOURCE_MUTATION"
    PROCESSED_JOURNAL_INCONSISTENCY = "PROCESSED_JOURNAL_INCONSISTENCY"
    PROCESSED_CLEANUP_FAILED = "PROCESSED_CLEANUP_FAILED"
    PROCESSED_RECOVERY_REQUIRED = "PROCESSED_RECOVERY_REQUIRED"
