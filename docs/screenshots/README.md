...
| `upgrade-advisor.png` | Tools -> Upgrade Advisor | Show upgrade, duplicate, or downgrade analysis. |
| `collection-gap-report.png` | Tools -> Collection Gap Report | Show grouped country/denomination gaps and completion percentages. |
| `want-list-workflow.png` | Tools -> Want List Preview or Want List Generator | Show staged acquisition intent or generated targets. |
